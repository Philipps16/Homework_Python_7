...
#     <function_name>("пара-ра-рам рам-пам-папам па-ра-па-дам") -> (True, [{'а': 4}, {'а': 2, 'у': 2}, {'а': 2, 'е': 1, 'о': 1}])
...
def rythm_check (song):
    words = song.split()
    rythm = lambda x: sum (1 for i in x if i in 'аоуыэеёиюя')
    res = rythm(words[0])
    if all ([rythm(i) == res for i in words]):
        return 'True'
    return 'False'

print (rythm_check("пара-ра-рам рам-пам-папам па-ра-па-дам"))
print (rythm_check("пара-ра-рам рам-пуум-пупам па-ре-по-дам"))
print (rythm_check("Трам-пара-папам-парам-па-пам-пам-па Пум-пурум-пу-пурум-трам-пам-па"))
print (rythm_check("Пам-парам-пурум Пум-пурум-карам"))
